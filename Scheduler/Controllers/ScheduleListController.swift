...
//  public let dataPersistence = DataPersistence(filename: "schedules.plist") We changed this to conform to the generic type on the Datapersistence helper
    // Below, is how we conform the generic type, witbh "Event"
  ...
  @IBAction func editButtonPressed(_ sender: UIBarButtonItem) {
    ...
    // with "_ event: Event? = nil", we provided a default parameter to provide a default value for the object
